...
public class Diamod_Adapter extends RecyclerView.Adapter<Diamod_Adapter.MyViewHolder> {
    ...
    public Diamod_Adapter(List<Products_Model> list, Context context) {
        this.filteredList = list;
        this.con = context;
    }

    public Diamod_Adapter(List<Products_Model> list) {
        this.filteredList = list;
    ...
    @Override
    public Diamod_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_product, parent, false);
        return new Diamod_Adapter.MyViewHolder(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    @Override
    public void onBindViewHolder(final Diamod_Adapter.MyViewHolder holder, final int position) {
        holder.T_title.setText(filteredList.get(position).getName());
        holder.T_Caliber.setText(filteredList.get(position).getCaliber());
        if(filteredList.get(position).getOriginalPrice()!=null) {
        ...
        if(filteredList.get(position).getSalesPrice()!=null) {
        ...
        holder.T_Price.setText(String.valueOf(value));
