...
public class BannersProduct_Adapter extends RecyclerView.Adapter<BannersProduct_Adapter.MyViewHolder>{

    private List<Slider_Banners> filteredList=new ArrayList<>();
...
//            T_Name = view.findViewById(R.id.T_Name);
    ...
    public BannersProduct_Adapter(List<Slider_Banners> list, Context context){
    ...
    @Override
    public BannersProduct_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.banner, parent, false);
        return new BannersProduct_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final BannersProduct_Adapter.MyViewHolder holder, final int position) {


        String i = filteredList.get(position).getFile();
        Uri u = Uri.parse(i);
